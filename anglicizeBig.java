 ...
 * @Description: Use the previous code but now make it so that it handles more numbers.
 * **************************************************************************/
import java.util.*;
...
public class anglicizeBig {
   ...
   // Outputs the english equivalent of n, for 0 < n < 1000000000
   ...
   // Returns the english equivalent of n, for 0 < n < 1000000000
   public static String anglicize1(int n) {
      ...
      if (n < 10000)
         ...
         s = anglicize2(n/10000) + "million " + anglicize2(n%10000);

      return s;
   }
   
   //Return the english equivalent of n, for 0 < n < 10000
   public static String anglicize2(int n) {
      ...
      if (n < 1000)
         ...
         s = anglicize3(n/1000) + "thousand " + anglicize3(n%1000);
   ...
   public static String anglicize3(int n) {
      ...
      if (n < 100)
         ...
         s = digitName(n/100) + "hundred " + anglicize4(n%100);
